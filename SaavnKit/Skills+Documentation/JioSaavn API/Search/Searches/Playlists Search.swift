...
struct PlaylistSearch: View {
    ...
    @State private var searchResults: JioSaavnPlaylistResponse?
    ...
    private func buildResultItemContainer(_ item: JioSaavnPlaylistResponse.JioSaavnPlaylistData.JioSaavnPlaylistResult) -> some View {
    ...
    func runSearch() {
        ...
        controller.searchPlaylists(query: editingKeyword,
